...
from src.model.ait.test_case.equipment.workstation_dto import WorkstationDTO
...
class WorkstationSetupDTO(WorkstationBaseDTO):
    createDate: datetime | None = None
    changeDate: datetime | None = None
    creator: str | None = None
    released: bool | None = None
    state: State | None = None
    workstationDtoList: list[WorkstationDTO] | None = None
